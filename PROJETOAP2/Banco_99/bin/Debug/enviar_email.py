...
try:
    ...
    # somente texto
    message = MIMEText('Seja muito bem-vindo ao Banco 99!\n\nNós estamos muito felizes por você ter nos escolhido, espero que nossos serviços possam satisfaze-lo(a).\n\nO número de sua conta é: {}\n\nAtenciosamente Banco 99.'.format(nconta)) # conteúdo da mensagem
