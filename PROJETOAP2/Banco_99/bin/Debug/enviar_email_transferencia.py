...
try:
    ...
    # somente texto
    message = MIMEText('\n\nParece que você está tentando fazer uma transferência bancária.\n\nUse o código abaixo para autorizar o processo\n\nCÓDIGO DE CONFIRMAÇÃO: {}'.format(codigoacesso)) # conteúdo da mensagem
    message['subject'] = 'Autorização de transferência bancária' # assunto do email
