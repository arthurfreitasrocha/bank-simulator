...
try:
    ...
    # somente texto
    message = MIMEText('O usuário: {}.\n\nPediu suporte através do caixa eletrônico.'.format(user)) # conteúdo da mensagem
    message['subject'] = 'Necessidade de Suporte' # assunto do email
