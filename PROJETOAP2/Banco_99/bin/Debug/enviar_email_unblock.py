...
try:
    ...
    # somente texto
    message = MIMEText('Parabéns! Nós fizemos as verificações necessárias e sua conta foi desbloqueada.\n\nTome um pouco mais de cuidado com ela da próxima vez.\n\nAtenciosamente Banco 99') # conteúdo da mensagem
    message['subject'] = 'Sua conta foi desbloqueada!' # assunto do email
