...
try:
    ...
    # somente texto
    message = MIMEText('Você solicitou o desbloqueio de seu cartão.\n\nDigite o código abaixo para autorizar a operação.\n\nCÓDIGO: {}'.format(codigoacesso)) # conteúdo da mensagem
    message['subject'] = 'Desbloquear cartão?' # assunto do email
