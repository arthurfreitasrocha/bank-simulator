...
try:
    ...
    # somente texto
    message = MIMEText('Parabéns, seu cartão foi desbloqueado com sucesso.\n\nVocê já pode voltar a aproveitar das várias vantagens oferecidas pelo Banco 99.\n\nAtenciosamente Banco 99') # conteúdo da mensagem
    message['subject'] = 'Cartão desbloqueado' # assunto do email
